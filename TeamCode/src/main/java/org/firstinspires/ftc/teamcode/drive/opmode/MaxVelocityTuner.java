...
public class MaxVelocityTuner extends LinearOpMode {
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return inchesPerSec / (2 * Math.PI * org.firstinspires.ftc.teamcode.drive.DriveConstants.WHEEL_RADIUS) / org.firstinspires.ftc.teamcode.drive.DriveConstants.GEAR_RATIO * DriveConstants.TICKS_PER_REV;
    }
}
