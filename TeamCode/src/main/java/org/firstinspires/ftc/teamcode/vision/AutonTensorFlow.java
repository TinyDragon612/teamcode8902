...
public class AutonTensorFlow extends LinearOpMode {
    ...
    private static final String TFOD_MODEL_ASSET = "detectBluePleasseee.tflite";
    ...
    private void initTfod() {
        ...
        builder.setCameraResolution(new Size(1920, 1080)); //(1920, 1080)
    ...
    private Recognition getMostLikely(){
        float max = 0;
