...
public class BluePropThreshold implements VisionProcessor {
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        Scalar lowHSVBlueLower = new Scalar(95, 100, 20);  //Beginning of Color Wheel
        Scalar lowHSVBlueUpper = new Scalar(135, 255, 255);

        Scalar highHSVBlueLower = new Scalar(95, 100, 20); //Wraps around Color Wheel
        Scalar highHSVBlueUpper = new Scalar(135, 255, 255);
